...
public class ProductUpdateDto {
	...
	private Collection<@Valid ProductVariantUpdateDto> variants;
	...
	public Collection<ProductVariantUpdateDto> getVariants() {
		return variants;
	}

	public void setVariants(Collection<ProductVariantUpdateDto> variants) {
