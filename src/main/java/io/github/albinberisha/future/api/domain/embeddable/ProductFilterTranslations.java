package io.github.albinberisha.future.api.domain.embeddable;
 ...
 */
@Embeddable
public class ProductFilterTranslations {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProductFilterTranslations other = (ProductFilterTranslations) obj;
